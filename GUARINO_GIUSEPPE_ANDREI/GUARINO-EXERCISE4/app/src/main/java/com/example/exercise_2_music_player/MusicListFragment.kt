...
class MusicListFragment : Fragment() {
    ...
    private val songs = listOf(
        ...
        "Song 4 - https://www.soundhelix.com/examples/mp3/SoundHelix-Song-2.mp3",
        "Song 5 - https://www.soundhelix.com/examples/mp3/SoundHelix-Song-3.mp3"
    )
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val songNames = songs.map { it.substringBefore(" - ") }
