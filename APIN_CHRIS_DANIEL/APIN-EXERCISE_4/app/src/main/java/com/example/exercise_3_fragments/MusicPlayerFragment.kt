...
class MusicPlayerFragment : Fragment() {
    ...
    override fun onAttach(context: Context) {
        ...
        navigationListener = when {
            parentFragment is OnNavigationListener -> parentFragment as OnNavigationListener
            context is OnNavigationListener -> context
            else -> throw RuntimeException("$context must implement OnNavigationListener")
        }
    }
